...
<Row>
  ...
  <Column justify="end" align="right">
    ...
    <Link href="https://meguro.es">meguro.es #26</Link>
  </Column>
</Row>
...
<Row>
  <Column align="left">
    ...
    <Text>Developer at Stand.fm</Text>
...
<Row>
  <Column align="left">
    <Text>Hermes Engine について</Text>
    <Text>Static Hermes による変化</Text>
    <Text>shermes、deno、bun の軽い比較</Text>
  </Column>
</Row>
...
<Row>
  <Column align="left">
    <Text>Hermes は JS をビルド前にバイトコードに変換する</Text>
    <Text>Static Hermes は JS をビルド前にネイティブコードに変換する</Text>
    <Text>Static Hermes は C のコードと平行して実行できる</Text>
    <Text>Hermes と Static Hermes は併用できる</Text>
    <Text>Static Hermes は React Native 外でも使える事が期待できる</Text>
  </Column>
</Row>
...
- [hermes docs](https://hermesengine.dev/)
- [RNEU 2019: Improving React Native Performance](https://youtu.be/BkRE4MsqFXU?si=LRXXWCm-YAMKN6r2)
- [RNEU 2023: Demystifying JavaScript Engines](https://www.youtube.com/watch?v=LIhDyF1Gatc)
- [RNEU 2023: Static Hermes: the Next Generation of Hermes](https://www.youtube.com/watch?v=q-xKYA0EO-c)
- [Discussion: How to try Static Hermes](https://github.com/facebook/hermes/discussions/1137)
- [Compiling TypeScript to Native Code](https://medium.com/@gautam1168/compiling-typescript-to-native-code-0238d69ca582)
